<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEmpre/EmpresasMaster.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="CapaPresentacion.MasterEmpre.Usuarios" %>
    ...
    <div class="col-lg-12">
        ...
        <div class="alert alert-primary d-flex flex-wrap justify-content-between align-items-center p-3 mb-4" role="alert">
            <div class="d-flex align-items-center">
                <i class="ti ti-users-group fs-32 me-3"></i>

                <div>
                    <h4 class="alert-heading mb-1 fw-bold">Gestión de Usuarios</h4>
                    <p class="mb-0">Administración de personal y accesos al sistema.</p>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="jsEmpre/Usuarios.js?v=<%= DateTime.Now.ToString("yyyyMMddHHmmss") %>" type="text/javascript"></script>
</asp:Content>
